...
public class DataBaseNameListCheckTest {
    @Test
    public void test001() {
        Jproxy.getInstance().initialize(DataBaseNameListCheckTest.class, false);
//        DataBaseNameListCheck textNameListCheck = new DataBaseNameListCheck();
