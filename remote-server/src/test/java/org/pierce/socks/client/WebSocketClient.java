 ...
 * under the License.
 */
package org.pierce.socks.client;
...
public final class WebSocketClient {
    ...
    static final String URL = System.getProperty("url", "ws://127.0.0.1:8444/websocket");
        ...
        try {
            ...
            while (true) {
                ...
                if (msg == null) {
                    ...
                    SocksCommandDNSRequest socksCommand = new SocksCommandDNSRequest();

                    socksCommand.setDomain(msg);
                    ch.writeAndFlush(socksCommand);
                }
            }
        } finally {
